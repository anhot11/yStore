...
class AppInstaller @Inject constructor(
    ...
    companion object {
        const val ACTION_INSTALL_STATUS =
            "y.Store.data.installer.AppInstaller.INSTALL_STATUS"

        const val EXTRA_PACKAGE_NAME =
            "y.Store.data.installer.AppInstaller.EXTRA_PACKAGE_NAME"
        const val EXTRA_VERSION_CODE =
            "y.Store.data.installer.AppInstaller.EXTRA_VERSION_CODE"
        const val EXTRA_DISPLAY_NAME =
            "y.Store.data.installer.AppInstaller.EXTRA_DISPLAY_NAME"
